...
public class CircleProgress extends View implements View.OnClickListener {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mFinishState = a.getInteger(R.styleable.CircleProgress_finishState, 1);
        a.recycle();
        ARROW_WIDTH = (int) (mBorderWidth * 2);
        ARROW_HEIGHT = (int) mBorderWidth;
        mColors = new int[4];
        mColors[0] = Color.WHITE;//context.getResources().getColor(R.color.white);
        mColors[1] = Color.WHITE;//context.getResources().getColor(R.color.white);
        mColors[2] = Color.WHITE;//context.getResources().getColor(R.color.white);
        mColors[3] = Color.WHITE;//context.getResources().getColor(R.color.white);

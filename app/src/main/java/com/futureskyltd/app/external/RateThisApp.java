...
public class RateThisApp {
     ...
     */
    public static void onStart(Context context, String from) {
     ...
     */
    public static boolean showRateDialogIfNeeded(final Context context, Context appContext) {
        onStart(appContext, "dialog");

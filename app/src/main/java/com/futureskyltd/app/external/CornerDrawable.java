...
public class CornerDrawable extends Drawable {
    ...
    public static final String TAG = "CornerDrawable";
    ...
    public static CornerDrawable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof CornerDrawable) {
                // just return if it's already a CornerDrawable
                return drawable;
     ...
     */
    public CornerDrawable setCornerRadius(@Corner int corner, float radius) {
     ...
     * @return the {@link RoundedDrawable} for chaining.
     */
    public CornerDrawable setCornerRadius(float topLeft, float topRight, float bottomRight,
                                           float bottomLeft) {
    ...
    public CornerDrawable setBorderWidth(float width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public CornerDrawable setBorderColor(@ColorInt int color) {
    ...
    public CornerDrawable setBorderColor(ColorStateList colors) {
    ...
    public CornerDrawable setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public CornerDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
    ...
    public CornerDrawable setTileModeX(Shader.TileMode tileModeX) {
    ...
    public CornerDrawable setTileModeY(Shader.TileMode tileModeY) {
